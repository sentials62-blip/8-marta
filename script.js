class App {
    ...
    // Определяем размер фото в зависимости от экрана
    let photoSize = 70; // по умолчанию для компьютера
    
    // Проверяем ширину экрана и устанавливаем размер
    ...
    for (let i = 0; i < photoCount; i++) {
        ...
        // Эффект при наведении (для телефонов - при касании)
        img.addEventListener('mouseenter', () => {
            img.style.transform = `translate(-50%, -50%) rotate(${pos.rotate}deg) scale(1.5)`;
            img.style.zIndex = '1000';
            img.style.boxShadow = '0 0 20px rgba(255,192,203,0.8)';
        });
